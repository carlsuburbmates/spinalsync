...
export default function QuizBlock({ question, options, answerIndex, explanation }: QuizBlockProps) {
  ...
  return (
    ...
    >
      ...
      {selected !== null && (
        <p className={`mt-3 text-sm ${isCorrect ? 'text-success' : 'text-critical'}`}>{
